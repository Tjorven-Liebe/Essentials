package de.ellyrion.tjorven.essentials.command.teleport_request

import de.ellyrion.tjorven.essentials.util.EssentialsCommand

class TeleportRequestDeclineCommand : EssentialsCommand("teleportrequest.teleportrequestdecline") {
